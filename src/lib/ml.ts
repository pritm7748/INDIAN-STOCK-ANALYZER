...
export function predictFutureTrends(
  ...
  // 6. WEIGHT ADJUSTMENT BASED ON TREND
  ...
  if (trendInfo.trend === 'UP' && trendInfo.strength > 50) {
    momentumWeight = 0.3;
    linearWeight = 0.3;
    logWeight = 0.25;
    smoothWeight = 0.15;
  } else if (trendInfo.trend === 'DOWN' && trendInfo.strength > 50) {
    momentumWeight = 0.3;
    linearWeight = 0.35;
    logWeight = 0.15;
    smoothWeight = 0.2;
  } else {
    // Sideways - rely more on mean reversion
    linearWeight = 0.4;
    smoothWeight = 0.3;
    momentumWeight = 0.15;
    logWeight = 0.15;
